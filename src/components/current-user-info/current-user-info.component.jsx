...
import {selectAnsweredPolls, selectCreatedPolls} from '../../redux/poll/poll.selectors';
...
const CurrentUserInfo = ({currentUser, currentUser:{avatarURL, name, id}, createdPolls, answeredPolls}) => {
    ...
    <p className="polls__number"><span className="polls__created">{createdPolls.length} Polls Created</span><span className="polls__created">{answeredPolls.length} Polls Joined</span></p>
        </div>
    )
}
